...
<header class="checkout-header">
  <div class="checkout-header__inner">
    ...
    <h1 class="checkout-title"><?= Lang::t('checkout.ok_heading') ?></h1>
...
<div class="checkout-wrap">
  <div class="tf-card" style="text-align:center;padding:2rem 1.25rem 2.25rem">
    ...
    <a class="checkout-back-link" href="https://tarumbasfarm.com/drops/es/lady-cupcake"><?= Lang::t('checkout.ok_home') ?></a>
  </div>
</div>
