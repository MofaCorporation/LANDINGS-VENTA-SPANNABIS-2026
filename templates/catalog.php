...
/** @var list<array{name: string, slug: string, hero: string, copy_key: string, cta_key: string}> $catalogItems */
...
<header style="display:flex;align-items:center;gap:clamp(1rem,3vw,2rem);padding:1rem 2rem;padding-right:10rem;background:#0e0610;border-bottom:8px solid #000;box-sizing:border-box;flex-wrap:wrap;position:relative;color:#fff;">
    ...
    <h1 style="font-family:Bangers,'Segoe UI',Impact,sans-serif;color:var(--pc,#a3ff12);font-size:clamp(1.35rem,3.8vw,1.95rem);margin:0;font-weight:400;line-height:1.05;text-transform:uppercase;letter-spacing:0.02em;flex:0 1 auto;min-width:0;max-width:100%;text-shadow:0 0 1px rgba(163,255,18,0.35);"><?= Lang::t('catalog.heading') ?></h1>
</header>

<main class="tf-catalog-main">
    <div class="tf-catalog-main__inner">
        <div style="text-align:center;max-width:42rem;margin:0 auto 2.5rem;padding:0 1.25rem;box-sizing:border-box;">
            <p style="margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(0.95rem,2.8vw,1.1rem);font-weight:700;line-height:1.55;color:#e4e2e2;"><?= Lang::t('catalog.subheading') ?></p>
        </div>
        ...
        <section style="text-align:center;max-width:44rem;margin:3rem auto 0;padding:0 1.25rem 2rem;box-sizing:border-box;border-top:4px solid #1a1919;padding-top:2.5rem;">
            <h2 style="margin:0 0 1rem;font-family:Bangers,'Segoe UI',Impact,sans-serif;font-size:clamp(1.25rem,4vw,1.85rem);font-weight:400;line-height:1.15;text-transform:uppercase;color:var(--pc,#a3ff12);letter-spacing:0.02em;"><?= Lang::t('catalog.footer_headline') ?></h2>
            <p style="margin:0;font-family:system-ui,-apple-system,sans-serif;font-size:clamp(0.9rem,2.6vw,1.05rem);font-weight:700;line-height:1.5;color:#bcbcbc;"><?= Lang::t('catalog.footer_sub') ?></p>
        </section>
    </div>
</main>
